...
class LoginComponent extends Component {
  constructor(props) {
    ...
    handleIncludeEmail = async () => {
        ...
        await LoginApi.LoginID(payload).then(res => {
        ...
        }).catch(error =>{ console.log(error);window.alert("Login unsuccessfull")})
    }
    ...
    return (
      <>
        <Space direction="vertical">
          <Input placeholder="Email Id" type="string"
                onChange={this.handleChangeEmailId} value={email_id} prefix={<UserOutlined />} />
